...
def league_fit_data(db, payload):
    ...
    rows = search_league_pool(db, {'leagues': [league['league_name']], 'countries': [league['league_country_name']], 'positions': list(roles), 'limit': 200}, role_gap_filter=True, excluded_player_id=metadata.get('player_id'))
